...
class _GroceryItemScreenState extends State<GroceryItemScreen> {
  ...
  Widget buildNameField() {
    return Column(
      ...
      children: [
        Text("Item Name", style: GoogleFonts.balooBhai(fontSize: 28.0,),),
        TextField(
  ...
  Widget buildImportanceField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Importance", style: GoogleFonts.balooBhai(fontSize: 28.0),),
        Wrap(
          spacing: 10.0,
          children: [
            ChoiceChip(
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text("Date", style: GoogleFonts.balooBhai(fontSize: 28.0),),
            TextButton(
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('Time of Day', style: GoogleFonts.balooBhai(fontSize: 28.0),),
            TextButton(
                child: const Text('Select'),
                onPressed: () async {
      ...
      children: [
        Row(
          children: [
            ...
            Text('Color', style: GoogleFonts.balooBhai(fontSize: 28.0),)
          ],
        ),
        TextButton(
          child: const Text('Select'),
  ...
  Widget buildQuantityField() {
    return Column(
      ...
      children: [
        Text(
          'Quantity',
          style: GoogleFonts.balooBhai(fontSize: 28.0),
        ),
        const SizedBox(width: 16.0),
        Text(
          _currentSliderValue.toInt().toString(),
          style: GoogleFonts.balooBhai(fontSize: 18.0),
        ),
        Slider(
